...
/* 시각 칸 — 한국시간 9시에 한 번만 넘어간다. 폰이 현지 시각이어도 기준은 서울이다. */
const kst = h => Date.UTC(2026, 8, 3, h - 9, 30);      // 한국시간 h시 30분
eq(MORE.bucket(kst(8)),  '2026-09-03T00', '한국시간 8:30 은 0시 칸');
eq(MORE.bucket(kst(9)),  '2026-09-03T09', '한국시간 9:30 은 9시 칸');
eq(MORE.bucket(kst(23)), '2026-09-03T09', '한국시간 23:30 도 9시 칸');
eq(MORE.bucket(kst(0)),  '2026-09-03T00', '한국시간 0:30 은 그날 0시 칸');
