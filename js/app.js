...
(function () {
  ...
  /* ★국기판은 **늘 세 장**, 이름은 **늘 열세 칸**이다. 나라 수만큼만 걸어 봤더니
     줄마다 이름이 다른 데서 시작해서 세로로 훑을 수가 없었다 — 자리가 고정된 것이
     이 판의 값이고, 빈 판은 값이 아니라 그 값의 모양이다.
     열세 칸은 제일 긴 이름('바르셀로나·포르투·리스본')에 맞춘 수다. */
  const FLAG_COLS = 3, NAME_COLS = 13;
